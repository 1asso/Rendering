...
from flow_gen import render_utils as utils

parser = argparse.ArgumentParser()
parser.add_argument('--in_root',  default='flow_gen/')
parser.add_argument('--in_dir',   default='flow_gen/test_1024/')
...
def run():
    ...
    args.out_name = 'flow'
    if args.out_dir == '':
        args.out_dir = os.path.join(args.in_root, 'flow')
    print(args.out_dir)
